...
#include "./radix_double_batcher_tbb.h"
...
TEST(ParallelTbb, OnlyPositiveEvenSize) {
...
TEST(SequenParallelTbbtial, OnlyPositiveOddSize) {
...
TEST(ParallelTbb, OnlyNegativeEvenSize) {
    std::vector<double> input = { -0.1, -0.0111, -1, -19, -120, -0.2, -0.00009, -2 };
    std::vector<double> sorted = radixBatcherSort(input);
...
TEST(ParallelTbb, OnlyNegativeOddSize) {
    std::vector<double> input = { -0.1, -0.0111, -1, -19, -120, -0.2, -0.00009, -2, -17 };
    std::vector<double> sorted = radixBatcherSort(input);
...
TEST(ParallelTbb, PositiveAndNegativeEvenSize) {
    std::vector<double> input = { -0.1, 0.0111, 1, -19, 120, -0.2, -0.00009, -2 };
    std::vector<double> sorted = radixBatcherSort(input);
