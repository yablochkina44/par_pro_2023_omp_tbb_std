...
#ifndef MODULES_TASK_3_MAKAROV_D_SOBEL_TBB_SOBEL_H_
#define MODULES_TASK_3_MAKAROV_D_SOBEL_TBB_SOBEL_H_
...
Matrix SobelTBB(const Matrix& input);
double clamp(double min, double max, double value);
void printMatrix(const Matrix& m);

#endif  // MODULES_TASK_3_MAKAROV_D_SOBEL_TBB_SOBEL_H_
