...
#include "../../../modules/task_3/chernova_a_ccs_matrix_mult/ccs_matrix_mult.h"
...
const MatrixCSS parallelCCSMultiplication(const MatrixCSS& left,
  ...
  tbb::parallel_for(
      tbb::blocked_range<int>(0, tLeft.numberColumns, 1),
      [&](tbb::blocked_range<int> r) {
        for (int leftColumn = r.begin(); leftColumn < r.end(); ++leftColumn) {
