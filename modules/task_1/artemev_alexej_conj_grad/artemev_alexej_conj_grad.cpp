...
std::vector<double> vecs_sum(const std::vector<double>& vec1, const std::vector<double>& vec2)
{
...
std::vector<double> mult_matrix_by_vec(const std::vector<std::vector<double>>& M, const std::vector<double>& vec)
{
    size_t size = vec.size();
    std::vector<double> result(size);
...
std::vector<double> conj_grad_method(const std::vector<std::vector<double>>& M, const std::vector<double>& vec)
{
    size_t size = vec.size();
