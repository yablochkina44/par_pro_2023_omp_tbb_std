...
#ifndef MODULES_TASK_1_ZBRUEV_D_MATRIX_CRS_COMPLEX_CRS_COMPLEX_H_
#define MODULES_TASK_1_ZBRUEV_D_MATRIX_CRS_COMPLEX_CRS_COMPLEX_H_
...
stupidDenseMultiplication(const std::vector<std::complex<double>>& a,
    ...
    const int size);
#endif  // MODULES_TASK_1_ZBRUEV_D_MATRIX_CRS_COMPLEX_CRS_COMPLEX_H_
