...
#ifndef MODULES_TASK_1_PROOFEV_STRASSEN_DOUBLE_STRASSEN_DOUBLE_H_
#define MODULES_TASK_1_PROOFEV_STRASSEN_DOUBLE_STRASSEN_DOUBLE_H_
...
void splitMatrix(const std::vector<double>& matr, std::vector<double>* a,
    std::vector<double>* b, std::vector<double>* c, std::vector<double>* d, unsigned int msize);
...
#endif  // MODULES_TASK_1_PROOFEV_STRASSEN_DOUBLE_STRASSEN_DOUBLE_H_