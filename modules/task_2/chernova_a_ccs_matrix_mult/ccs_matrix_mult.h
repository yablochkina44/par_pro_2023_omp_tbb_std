...
#ifndef MODULES_TASK_1_CHERNOVA_A_CCS_MATRIX_MULT_H_
#define MODULES_TASK_1_CHERNOVA_A_CCS_MATRIX_MULT_H_
...
class MatrixCSS {
 ...
 public:
  ...
  friend const MatrixCSS parallelCÑSMultiplication(const MatrixCSS& left,
                                                   const MatrixCSS& right);
};
...
#endif  // MODULES_TASK_1_CHERNOVA_A_CCS_MATRIX_MULT_H_
